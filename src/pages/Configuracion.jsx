    ...
    <div className="min-h-screen bg-manga-bg pt-16">
      <div className="border-b border-manga-border bg-manga-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-manga-muted text-sm">Personaliza tu experiencia</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex items-center justify-center">
        <div className="text-center max-w-sm">
          ...
          <p className="text-manga-muted text-sm mb-6">
            Accede a la configuración de tu cuenta, notificaciones, idioma y preferencias de lectura.
          </p>
