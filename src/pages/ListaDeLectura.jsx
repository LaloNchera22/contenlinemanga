...
export default function ListaDeLectura() {
  return (
    <div className="min-h-screen bg-manga-bg pt-16">
      <div className="border-b border-manga-border bg-manga-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center gap-3 mb-1">
            <Bookmark className="w-7 h-7 text-manga-red" />
            <h1 className="text-3xl font-black text-white">Lista de lectura</h1>
          </div>
          <p className="text-manga-muted text-sm">Tu biblioteca personal de manga</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex items-center justify-center">
        <div className="text-center max-w-sm">
          ...
          <p className="text-manga-muted text-sm mb-6">
            Guarda tus mangas favoritos y accede a tu lista desde cualquier dispositivo.
          </p>
